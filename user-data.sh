...
# Create gateway config only on first deploy — preserve manual config across spot interruptions
...
# Create .env only on first deploy — preserve keys/tokens added after initial setup
